    ...
    Future<Map<String, dynamic>> getUserData(String email) async {
      try {
        ...
        DatabaseEvent event = await reference
            ...
            .child('FacultyInfo')
            .orderByChild('email')
            .equalTo(loggedInEmail)
            .once();

        DataSnapshot dataSnapshot = event.snapshot;

        if (dataSnapshot.value != null) {
          // Assuming there might be multiple records with the given email
          ...
          if (userData != null && userData.isNotEmpty) {
            ...
            final invigilation_date = (userRecord['timings'] ?? 'No Data Found')
                .toString(); // Convert to String
          ...
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return Center(
              child: AlertDialog(
                ...
                title: Center(
                  child: Text(
                    'You are Not Faculty of Our College',
